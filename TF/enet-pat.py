...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', default='train2017.lmdb',
                        help='Can be either a LMDB generated by `data_sampler.py` or the original COCO zip.')
    parser.add_argument('--vgg19', help='load model', default="vgg19.npz")
